const PolicyContent = () => {
    return (
          <div className="px-[50px] lg:px-[330px]">
        <span className="font-Glacial text-[20px] ">
          <br />
          Effective date: 1st October 2021Ethlas ("us", "we", or "our") operates
          the website.This page informs you of our policies regarding the
          ...
          Conditions.
          <br />
          <br /> I. INFORMATION COLLECTION AND USE
          <br />
          <br /> We collect several different types of information for various
          purposes to provide and improve our Service to you.If you do not use
          (log in to) the service for two years all your personal data will be
          deleted.Types of Data Collected:1. Personal DataWhile using our
          ...
          but is not limited to:Email address, Cookies, and Usage Data2. Usage
          DataWe may also collect information that your browser sends whenever
          ...
          the Service by or through a mobile device, this Usage Data may include
          ...
          device identifiers and other diagnostic data.3. Tracking Cookies
          DataWe use cookies and similar tracking technologies to track the
          ...
          scripts to collect and track information and to improve and analyze
          ...
          II. USE OF DATA
          <br />
          <br /> Ethlas uses the collected data for various purposes:
          <br />
          <br />
          To provide and maintain the Service To notify you about changes to our
          Service
          <br />
          <br />
          ...
          United States and process it there.Your consent to this Privacy Policy
          followed by your submission of such information represents your
          agreement to that transfer.Ethlas will take all steps reasonably
          ...
          <br />
          IV. DISCLOSURE OF DATA <br />
          <br />
          Legal Requirements Ethlas may disclose your Personal Data in the good
          faith belief that such action is necessary to:To comply with a legal
          obligation To protect and defend the rights or property of Ethlas To
          prevent or investigate possible wrongdoing in connection with the
          Service To protect the personal safety of users of the Service or the
          public To protect against legal liability <br />
          <br />
          V. SECURITY OF DATA <br />
          <br />
          ...
          <br />
          <br />
          IX. CHANGES TO THIS PRIVACY POLICY <br />
          <br />
          ...
          are effective when they are posted on this page. <br />
          <br />
          X. CONTACT US <br />
          <br />
          If you have any questions about this Privacy Policy, please contact
          us:Email: hello@ethlas.comIf you would like to know what kind of
          information we are storing regarding your user, please email
          hello@ethlas.com and use the subject “SAR: user”If you would like your
          personal data deleted, please email hello@ethlas.com and use the
          subject: “Delete:User”
        </span>
      </div>
    );
